...
const Reports: React.FC<Props> = ({ events, onNavigate, showValues }) => {
  ...
  return (
    <div className="pb-32 animate-in fade-in duration-700">
      <header className="sticky top-0 z-50 bg-white dark:bg-background-dark/95 ios-blur px-4 h-16 flex items-center border-b border-slate-100 dark:border-slate-800 shadow-sm">
